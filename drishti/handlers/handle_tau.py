...
def handler():
    ...
    if df_intervals['api'].eq('POSIX').any():
        ...
        df_posix_with_offset = df_posix[df_posix['offset'] != 'Unknown']
        df_posix_with_offset = df_posix_with_offset.astype({'offset': int})

        max_read_offset = df_posix_with_offset[(df_posix_with_offset['function'].str.contains('read'))]['offset'].max()
        max_write_offset = df_posix_with_offset[~(df_posix_with_offset['function'].str.contains('read'))]['offset'].max()
        ...
        grp_posix_by_id = df_posix_with_offset.groupby('file_id')
        ...
        detected_files = df_posix.groupby('file_id')['rank'].nunique()
